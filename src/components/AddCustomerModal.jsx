...
import { X, Plus, Trash2, Link as LinkIcon, User, Briefcase, Tag, FileText } from 'lucide-react';
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        >
          <div className="p-6 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-white dark:bg-slate-900 sticky top-0 z-10">
            <div>
              <h2 className="text-xl font-bold dark:text-white">Tambah Customer Baru</h2>
              <p className="text-sm text-slate-500 dark:text-slate-400">Masukkan detail prospek baru Anda.</p>
            </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Link Kontak</label>
                <button
                  type="button"
